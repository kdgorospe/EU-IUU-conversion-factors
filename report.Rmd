...
![Figure 4a](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Bar Graphs/landings_vs_catch_case_study_4_Gadus morhua Fresh, gutted and headed_norway_removed.png)

![Figure 4b](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Bar Graphs/landings_vs_catch_case_study_4_Gadus morhua Fresh, gutted and headed.png)

![Figure 5a](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series Country vs EU values/landings-vs-catch_Portugal-vs-EU_Gadus-morhua.png)

![Figure 5b](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series Country vs EU values/landings-vs-catch_Norway-vs-EU_Gadus-morhua.png)

![Figure 6](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series of min vs max CF/landings-vs-catch_min-vs-max-CF_Gadus-morhua.png)
[Kelvin - we can probably just start this plot at 2000]

### Hake (*Merluccius merluccius*)

![Figure 7a](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Bar Graphs/landings_vs_catch_case_study_10_Merluccius merluccius Fresh, gutted and headed.png)

![Figure 8a](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series Country vs EU values/landings-vs-catch_Portugal-vs-EU_Merluccius-merluccius.png)

![Figure 8b](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series Country vs EU values/landings-vs-catch_Norway-vs-EU_Merluccius-merluccius.png)

![Figure 9](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series of min vs max CF/landings-vs-catch_min-vs-max-CF_Merluccius-merluccius.png)
[Kelvin - we can probably start this plot at 2000]
### Monkfish (*Lophiidae*)

![Figure 10a](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Bar Graphs/landings_vs_catch_case_study_7_Lophiidae Fresh, gutted and headed.png)

![Figure 10b](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Bar Graphs/landings_vs_catch_case_study_8_Lophiidae Frozen, gutted and headed.png)



![Figure 11](Images/Section - EU Fishery Case Studies/Proposed Final Plots/Time Series of min vs max CF/landings-vs-catch_min-vs-max-CF_Lophiidae.png)
...
![Figure 12: Illustration of the live weight equivalent calculation based on trade data reported as trade codes that include multiple species and presentations](Images/trade_LWE_calc_fig.png)
