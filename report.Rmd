...
Figure 2: Catch time series comparing landed weight or live weight equivalent (depending on what data we can find) using difference CF's for EU value compared to Member State(s)
...
Figure 3: Catch time series comparing landed weight or live weight equivalent (depending on what data we can find) using difference CF's for EU versus non-EU States
