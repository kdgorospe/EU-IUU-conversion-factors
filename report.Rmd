...
Comparing the live weight conversion factors across species-presentation-state combinations landed in the EU reveals substantial variability for some products (Figure 2). The largest range is for the family *Lophiidae*, frozen, headed and gutted, which ranges from 1.2 to 3.25, representing a 170% difference in catch estimates (Figure 2). [Kelvin, can you add ~2 more examples with the numbers here (any of the top ones is fine)?] 
